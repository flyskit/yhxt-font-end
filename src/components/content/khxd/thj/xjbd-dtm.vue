<template lang='pug'>
  div.khxd-thj-xjbd-dtm
    Button.khxd-operate-button(@click="getBoardHanging") 吊趟门料型
...
export default {
  ...
  components: {
    ...
    'reworkModal': (resolve) => require(['./modal/rework-hanging-main'], resolve),
  ...
  methods: {
    ...
    /** 创建返工订单-弹窗 */
    createRework() {
      this.$refs.reworkModal.show(this.hangingType);
    },
    /** 材料报价信息 */
    getBoardHanging() {
      this.$refs.boardModal.show(this.hangingType);
    }
  }
};
</script>
