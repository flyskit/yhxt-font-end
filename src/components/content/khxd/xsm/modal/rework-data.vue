...
export default {
  ...
  methods: {
    /** 显示 */
    show(blisterDetail, orderDetail, orderSizes) {
      ...
      this.orderDetail[0].bc = blisterDetail.bc;
      this.orderDetail[0].dj = blisterDetail.dj;
      this.$refs.editBlisterSize.showSize(orderSizes);
      this.getBh();
      this.getBc();
      this.$refs.editBlisterSize.computeDataAgain();
      this.visible = true;
    },
    /** 获取编号 */
    getBh() {
