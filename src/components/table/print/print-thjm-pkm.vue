<template lang='pug'>
  div.table-print-thjm-pkm(v-if="isShow")
    div
      table.print-table-style(border)
        tr
          td.print-table-style-title(colspan="11" cellspacing="0" cellpadding="0") 艺合钛合金-平开门生产订单
